...
;(function (root, factory) {
  ...
  //defaults for plugin
  var defaults = {
    gridWidth: 200, //minumum width of a grid, this may increase to take whole space of container
    gutterSize: 15, //spacing between two grid,
    gridNo: '2', // grid number, by default calculate auto matically
